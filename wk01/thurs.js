...
// console.log(thisArray.length);  90
// console.log(thatArray.length);  76


// var randomThisArray = thisArray[Math.floor(Math.random() * thisArray.length)];
// var randomThatArray = thatArray[Math.floor(Math.random() * thatArray.length)];

// console.log(randomThisArray + " for " + randomThatArray);
...
//empty array to place generated statements
var coolIdeasArray = [];

//want to have a variable that runs a loop 5 times and generates a new combo 
var makeIdeasArray = function () {
  	for (i = 0; i < 6; i++) {
    	
  }
};

//need to store this information... in a variable?
//need to call call this information and print it to console
